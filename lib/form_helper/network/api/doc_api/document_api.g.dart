...
class _DocumentApi implements DocumentApi {
  ...
  @override
  Future<HttpResponse<dynamic>> getDocAddType() async {
  ...
  @override
  Future<HttpResponse<dynamic>> getAccomodationType() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch(_setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'UserDocs/getAccomandationDocType/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
