class LocalUserModal {
  int? responseCode;
  int? responseStatus;
  ResponseData? responseData;
  String? responseMsg;

  LocalUserModal({this.responseCode, this.responseStatus, this.responseData, this.responseMsg});

  LocalUserModal.fromJson(Map<String, dynamic> json) {
